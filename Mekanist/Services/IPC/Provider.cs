...
public partial class Provider : IDisposable
{
    ...
    public static Provider Init()
    {
        ...
        EzIPC.Init(output, prefix: "Mekanist");
    ...
    ///     <c>void MekanistCallback(int, string)</c>.<br />
    ///     See <see cref="LeaseeIPC.MekanistCallback" /> for the exact signature that
    ///     will be called.
    /// </remarks>
