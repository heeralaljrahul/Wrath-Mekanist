...
using Setting = Mekanist.Window.Functions.Setting;
...
internal class Settings : ConfigWindow
{
    ...
    private static void DrawSetting(Setting setting)
    {
        ...
        // Removed retargeting symbols - Not applicable to Mekanist (MCH-only)
        #endregion
    ...
    private static void DrawCollapseGroup(string groupName)
    {
        ...
        // Removed - Not applicable to Mekanist (MCH-only, no healing/raising)
        #endregion
