...
using Mekanist.Services.ActionRequestIPC;
namespace Mekanist;

/// <summary> Main plugin implementation. </summary>
public sealed partial class Mekanist : IDalamudPlugin
{
    ...
    /// <summary> Initializes a new instance of the <see cref="Mekanist"/> class. </summary>
    /// <param name="pluginInterface"> Dalamud plugin interface. </param>
    public Mekanist(IDalamudPluginInterface pluginInterface)
    {
        P = this;
        ...
        DtrBarEntry ??= Svc.DtrBar.Get("Mekanist");
    ...
    private void PrintMotD()
    {
        try
        {
            var basicMessage = $"Welcome to Mekanist v{this.GetType().Assembly
                .GetName().Version}!";
            using var motd =
