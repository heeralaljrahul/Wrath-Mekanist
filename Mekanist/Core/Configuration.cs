...
using Mekanist.AutoRotation;
using Mekanist.Window;
using Mekanist.Attributes;
using Mekanist.Window.Functions;
using Mekanist.Window.Tabs;
using Mekanist.Combos.PvE;
using Mekanist.CustomComboNS.Functions;
using static Mekanist.Attributes.SettingCategory.Category;
using static Mekanist.CustomComboNS.Functions.CustomComboFunctions;
using Setting = Mekanist.Attributes.Setting;
using Space = Mekanist.Attributes.SettingUI_Space;
using Or = Mekanist.Attributes.SettingUI_Or;
using Retarget = Mekanist.Attributes.SettingUI_RetargetIcon;

#endregion

// ReSharper disable RedundantDefaultMemberInitializer

namespace Mekanist.Core;
...
public partial class Configuration : IPluginConfiguration
{
    ...
    /// <seealso cref="Mekanist.OnFrameworkUpdate"/>
    [SettingCategory(Main_UI_Options)]
    ...
    /// <seealso cref="Mekanist.HandleComboCommands" />
    [SettingCategory(Rotation_Behavior_Options)]
